...
Credits:
    - This script uses pvlib (BSD 3-Clause) for solar position, irradiance transposition, and PV temperature modeling.
      pvlib: https://pvlib-python.readthedocs.io/  (see pvlib license in its repository)
      
    - examples for user defined parameters come from sceintific publications refereced below
...
gamma = 0.004        # gamma coefficient linking temperature variation to efficiency variation from https://doi.org/10.1016/j.heliyon.2022.e11896
eta_stc = 0.1649     # efficiency at STC of the panels from https://doi.org/10.1016/j.apenergy.2020.116084
